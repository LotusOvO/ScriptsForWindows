...
def make_video_link(src_path, dst_path="./SymbolicLink", copy_small_file_flag=True):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--season',
                        default=1,
                        type=int,
                        help="the season number (default: 1). eg. --season 1 --> S01")
    parser.add_argument('-b', '--begin',
                        default=1,
                        type=int,
                        help="the begin number (default: 1). eg. --begin 1 --> E01, E02, E03...")
    parser.add_argument('-r', '--repetition',
                        default=1,
                        type=int,
                        help="the repetition number (default: 1). eg. --repetition 2 --> E01, E01, E02...")
    args = parser.parse_args()
    make_video_link(args.src, args.dst, args.all)
    if args.original:
